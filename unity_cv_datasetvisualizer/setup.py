...
setuptools.setup(
    ...
    packages=["unity_cv_datasetvisualizer/datasetvisualizer", "unity_cv_datasetvisualizer/datasetvisualizer/helpers", "unity_cv_datasetvisualizer/datasetvisualizer/visualization"],
